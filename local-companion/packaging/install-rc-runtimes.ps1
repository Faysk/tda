...
function Install-RcRuntime([string]$Family, [string]$Artifact, [string]$ResultName) {
...
$whisper = Install-RcRuntime "whisper" $WhisperArtifact "rc-whisper-runtime.json"
$qwen = Install-RcRuntime "qwen" $QwenArtifact "rc-qwen-runtime.json"
