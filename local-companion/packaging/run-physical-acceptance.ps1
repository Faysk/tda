...
if (
    ...
    [string]$candidate.version -notmatch '^[0-9]+\.[0-9]+\.[0-9]+function Get-RuntimeWorker {
    param(
...
if (
    -not $driverVersion -or
    -not $gpuName -or
    $computeCapability -notmatch '^[0-9]+\.[0-9]+
...
if ($WriteTranscripts) { Write-Host "Local transcripts were explicitly requested and written under: $output" }
 -or
    [string]$candidate.source_sha -notmatch '^[a-f0-9]{40}function Get-RuntimeWorker {
    param(
        [Parameter(Mandatory = $true)][string]$Family,
        [Parameter(Mandatory = $true)][string]$RuntimeId,
        [Parameter(Mandatory = $true)][string]$Executable
...
if ($WriteTranscripts) { Write-Host "Local transcripts were explicitly requested and written under: $output" }
 -or
    [string]$candidate.source_tree_sha -notmatch '^[a-f0-9]{40}function Get-RuntimeWorker {
    param(
        [Parameter(Mandatory = $true)][string]$Family,
        [Parameter(Mandatory = $true)][string]$RuntimeId,
        [Parameter(Mandatory = $true)][string]$Executable
...
if ($WriteTranscripts) { Write-Host "Local transcripts were explicitly requested and written under: $output" }
 -or
    [string]$candidate.tag -notmatch '^companion-rc-v[0-9]+\.[0-9]+\.[0-9]+-[a-f0-9]{12}function Get-RuntimeWorker {
    param(
        [Parameter(Mandatory = $true)][string]$Family,
        [Parameter(Mandatory = $true)][string]$RuntimeId,
        [Parameter(Mandatory = $true)][string]$Executable
...
if (
    ...
    [string]$msiAsset.sha256 -notmatch '^[a-f0-9]{64}function Get-RuntimeWorker {
    param(
        [Parameter(Mandatory = $true)][string]$Family,
        [Parameter(Mandatory = $true)][string]$RuntimeId,
        [Parameter(Mandatory = $true)][string]$Executable
...
if ($WriteTranscripts) { Write-Host "Local transcripts were explicitly requested and written under: $output" }
 -or
    [string]$payloadAsset.sha256 -notmatch '^[a-f0-9]{64}function Get-RuntimeWorker {
    param(
        [Parameter(Mandatory = $true)][string]$Family,
        [Parameter(Mandatory = $true)][string]$RuntimeId,
        [Parameter(Mandatory = $true)][string]$Executable
...
if ($WriteTranscripts) { Write-Host "Local transcripts were explicitly requested and written under: $output" }
 -or
    $RequireGpuName.ToLowerInvariant() -notin @("", $gpuName.ToLowerInvariant())
) {
