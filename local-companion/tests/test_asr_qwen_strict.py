...
def test_strict_qwen_reuses_1_0_10_text_checkpoint_after_policy_only_upgrade(
    monkeypatch,
    tmp_path: Path,
):
    package, root = _package(tmp_path)
    ...
    stable_fingerprint = (
        "checkpoint=qwen-track-v3;"
        "runtime=1.0.10;"
        "worker_sha256=8c07e1c3bd34ecc53d49025a510c7547e7748b030ac6a90fdd70a2abc431e62e"
    )
    ...
    def forbidden(*_args, **_kwargs):
        raise AssertionError(
            "policy-only retry must reuse Stable 1.0.10 ASR text"
        )
