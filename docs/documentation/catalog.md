...
| [Login Discord: configuração e verificação](../operations/discord-auth.md) | identity/access | runtime integrado; configuração production publicada; OAuth real pendente | 2026-09-07 |
