...
| [Lembra — biblioteca compartilhada de referências visuais](../features/lembra.md) | frontend / integrations-media / identity-access | persistência compartilhada em Production; refinamento de feedback/proporção em implementação na #476 | 2026-09-22 |
...
| [Estatísticas privadas de transcrições](../features/transcript-statistics.md) | transcrições / leitura e estatísticas | leitura legacy publicada; benchmark Production concluído em 2026-09-23; read model bounded em candidato #540 | 2026-09-22 |
