...
- `candidates/20260923143000_transcript_statistics_read_model.sql` — read model server-only por sessão para #537, com `text_words` derivado e agregado transacional; **flag off e não autorizado para Production**;
