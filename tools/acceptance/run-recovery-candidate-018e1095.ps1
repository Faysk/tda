param(
    [string]$OutputRoot = (Join-Path $env:LOCALAPPDATA "TDA\State\acceptance\recovery-018e1095"),
...
$RcTag = "companion-rc-v0.3.14-018e109530ba"
$Version = "0.3.14"
$SourceSha = "018e109530ba2306bfb686ade182fbd93156604a"
$CandidateSha256 = "1613c822fa5d173b66c38fff590329e181a897e4b1664e2329bf4874364d15fe"
$MsiSha256 = "87de762282f3626944d96bb49d8253692b64c3fa0c2db3c26482b30c93858ffa"
$PayloadSha256 = "6b7c1476adc3142f5532fae4bd6a95aef935a18d4bd3b207ed4027f28ed80d62"
...
& $generator -OutputRoot $fixtureRoot -TargetSeconds 80
...
& $installedScript `
    ...
    -Port $Port
if ($LASTEXITCODE -ne 0 -or -not (Test-Path -LiteralPath $installedRaw -PathType Leaf)) {
